...
btn4.onclick =  function (){
        location.href="https://mahmoud7732.github.io/mahmoudproject.github.io/contact_us.html"
}
...
let doc_img = document.getElementById("join_doc"); // join us
window.onscroll = function () {
        ...
        if(window.scrollY >= 2700){
                doc_img.style.opacity = '1';
        }else{
                doc_img.style.opacity = '0'
        }
};
